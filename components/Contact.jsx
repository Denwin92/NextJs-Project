...
☺️ .</p>
            ...
            <div className=" col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
                ...
                <form action="mailto:Denwin.Solomons@gmail.com" method="get" enctype="text/plain">
                    ...
                    <textarea className="border-2 rounded-lg p-3 flex border-gray-300" name="comments" rows='10' />
                    </div>
